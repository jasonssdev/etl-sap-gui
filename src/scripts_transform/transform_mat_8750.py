...
def get_file_paths(base_path):
    ...
    return material_moar_path, material_8750_processed_path, material_8750_exported_path
...
def transform_mat_8750(material_moar_path, processed_path, exported_path):
    try:
        ...
        df_material_moar.to_csv(processed_path, index=False, encoding='latin1')
        df_material_moar.to_csv(exported_path, index=False, encoding='latin1')
...
if __name__ == "__main__":
    base_path = os.getcwd()
    material_moar_path, material_8750_processed_path, material_8750_exported_path = get_file_paths(base_path)
    transform_mat_8750(material_moar_path, material_8750_processed_path, material_8750_exported_path)
