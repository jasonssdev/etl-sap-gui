...
def get_file_paths(base_path):
    ...
    material_3000_uploaded_path = os.path.join(mapped_network_path, 'data', 'tbl_material_3000.csv')
    return material_momx_path, material_3000_processed_path, material_3000_exported_path, material_3000_uploaded_path
...
def transform_mat_3000(material_momx_path, processed_path, exported_path, uploaded_path):
    try:
        ...
        df_material_momx.to_csv(processed_path, index=False, encoding='latin1', sep='|')
        df_material_momx.to_csv(exported_path, index=False, encoding='latin1', sep='|')
        df_material_momx.to_csv(uploaded_path, index=False, encoding='latin1', sep='|')
...
if __name__ == "__main__":
    base_path = os.getcwd()
    material_momx_path, material_3000_processed_path, material_3000_exported_path, material_3000_uploaded_path = get_file_paths(base_path)
    transform_mat_3000(material_momx_path, material_3000_processed_path, material_3000_exported_path, material_3000_uploaded_path)
